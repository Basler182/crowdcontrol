...
public final class DrawableUtil {
     ...
     */
    @Nullable
    public static BitmapDescriptor getBitmapDescriptor(Context context, @DrawableRes int id, SupermarketDTO supermarketDTO) {
        ...
        Log.wtf("GETLIST", String.valueOf(supermarketDTO.getListId()));
        paint.getTextBounds(String.valueOf(supermarketDTO.getListId()), 0, String.valueOf(supermarketDTO.getListId()).length(), bounds);
        int x = (bitmap.getWidth() - bounds.width())/2;
        int y = (bitmap.getHeight() + bounds.height())/2;

        canvas.drawText(String.valueOf(supermarketDTO.getListId()), x, y, paint);
